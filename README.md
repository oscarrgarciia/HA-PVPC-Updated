...
> ℹ️ **Release v1.2.0** automates the calculation of holiday dates so it no longer depends on yearly manual updates. Please test it and if you find any issues open an issue so we can fix it as soon as possible, in the meantime you can always roll back to v1.1.1 which works fine. Thank you all for your support! ❤️
